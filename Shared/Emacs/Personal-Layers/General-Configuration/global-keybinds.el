...
(define-key evil-normal-state-map (kbd "S-i") 'evil-scroll-line-to-center)
(define-key evil-normal-state-map (kbd "S-o") 'evil-join)
...
(define-key evil-normal-state-map (kbd "S-f") 'evil-snipe-T)
(define-key evil-normal-state-map (kbd "S-t") 'evil-snipe-F)
