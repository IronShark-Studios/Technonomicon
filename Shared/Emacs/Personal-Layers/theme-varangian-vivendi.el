...
(setq modus-themes-vivendi-color-overrides
      '((bg-main . "#1f1f1f")
        ...
        (magenta . "#836fff")
        (magenta-alt . "#836fff")
        (magenta-alt-other . "#836fff")
        (magenta-warmer . "#ab82ff")
        (magenta-cooler . "#7d26cd")
        (magenta-faint . "#bf3eff")
        (magenta-alt-faint . "#bf3eff")
        (magenta-alt-other-faint . "#bf3eff")
        (magenta-intense . "#9b30ff")
        (cyan . "#00d3d0")
        (cyan-alt . "#00d3d0")
